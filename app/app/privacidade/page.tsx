...
const sections = [
  ...
  },
  {
    ...
    body: "Usamos provedores de infraestrutura (hospedagem, banco de dados, envio de e-mail) que processam dados em nosso nome, sob contrato e apenas para operar o serviço. Integrações que a própria agência ativa (Google Drive, Slack, HubSpot, Asana, Stripe) trocam dados diretamente com essas plataformas, conforme autorizado pela agência via OAuth.",
  },
  {
    title: "5. Retenção",
  ...
  {
    title: "8. Segurança",
    body: "Dados em trânsito são protegidos com TLS e credenciais de integração são armazenadas de forma criptografada. Mais detalhes na página de Segurança.",
  },
  {
    title: "9. Alterações",
      ...
      <main className="flex-grow">
        <section className="py-20 lg:py-24">
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl mb-2">Política de Privacidade</h1>
