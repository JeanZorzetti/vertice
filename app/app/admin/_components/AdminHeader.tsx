...
export default function AdminHeader({ userName, userEmail, initials }: AdminHeaderProps) {
    ...
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0 z-10">
      ...
      <Link href="/admin" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
        ...
        <div className="flex items-center gap-2">
          <span className="font-black text-slate-900 tracking-tight">Vértice</span>
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative group">
          <button className="flex items-center gap-2.5 pl-2 pr-3 py-1.5 rounded-xl hover:bg-slate-100 transition-colors">
            <div className="w-8 h-8 rounded-full bg-[#135bec] flex items-center justify-center shrink-0">
          ...
          {/* Dropdown */}
          <div className="absolute right-0 top-full mt-1 w-48 bg-white border border-slate-200 rounded-xl shadow-lg shadow-slate-900/10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
            <div className="p-1">
              <button
