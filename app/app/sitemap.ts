...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${SITE_URL}/funcionalidades`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}/precos`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    { url: `${SITE_URL}/integracoes`, lastModified, changeFrequency: "monthly", priority: 0.6 },
    ...
    { url: `${SITE_URL}/blog/onboarding-e-o-primeiro-contato-real`, lastModified, changeFrequency: "yearly", priority: 0.4 },
